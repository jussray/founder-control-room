...
if (added.length > 0) {
  failures.push(
    `new tests are excluded from default npm test discovery: ${added.join(', ')}. Move them into the active default include pattern or record pre-existing base debt only.`,
  );
}
