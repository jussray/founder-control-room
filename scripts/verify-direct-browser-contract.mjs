...
assert.match(missionLiveProof, /desktop-draft-survives\.png/);
assert.match(missionLiveProof, /Do not lose this note during polling\./);
assert.match(missionLiveProof, /runAfterReview/);
