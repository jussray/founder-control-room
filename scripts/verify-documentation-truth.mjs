...
const truthSensitiveRules = [
  ...
  { domain: 'economic-intelligence', match: /^src\/economic-intelligence\/(?!__tests__\/)(?!.*\.test\.ts$)/ },
  { domain: 'economic-intelligence', match: /^src\/http\/routes\/economicIntelligence\.ts$/ },
...
const consistencyChecks = [
  ...
  [readme.includes('Economic Intelligence execution truth') && readme.includes('truth-sensitive'), 'README must describe Economic Intelligence as a truth-sensitive execution surface'],
  ...
  [truthDecay.includes('Economic Intelligence is now explicitly part of the same truth-sensitive registry'), 'truth-decay audit must register Economic Intelligence as truth-sensitive'],
  ...
  [adaptiveKernel.includes('does **not** claim') && adaptiveKernel.includes('instruction and decision loops'), 'adaptive kernel must stay scoped to governance behavior unless runtime integration is separately implemented and proven'],
