...
const truthSensitiveRules = [
  ...
  { domain: 'pair-authority', match: /^\.control-room\/founder-chief-pair-peer-lock\.json$/ },
  { domain: 'pair-authority', match: /^scripts\/verify-founder-chief-pair\.mjs$/ },
  { domain: 'pair-authority', match: /^\.github\/workflows\/founder-chief-pair-contract\.yml$/ },
