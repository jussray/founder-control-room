...
const server = createServer(async (req, res) => {
  ...
  if (req.url === '/quickscan' && req.method === 'GET') { res.setHeader('content-type','application/json'); return res.end(JSON.stringify({ contract:'founder-control-room/quickscan@v1', authority:{ sendExternal:false, executeN8n:false, stripeWebhookConfigured:false }, prospects:[prospect] })); }
