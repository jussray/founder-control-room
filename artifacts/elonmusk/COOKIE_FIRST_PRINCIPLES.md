...
1. What server validates the value?
2. What authority does it prove?
3. How is it revoked?
4. Why must the browser attach it automatically?
5. What prevents CSRF?
6. What prevents CDN caching and cross-user leakage?
...
- Delete first-party storefront cookies when checkout is delegated to a hosted provider.
...
- All remaining repos: zero cookies until a verified need exists.
