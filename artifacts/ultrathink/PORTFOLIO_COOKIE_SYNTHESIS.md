...
Use a cookie allowlist, not a cookie toolkit. Founder Control Room owns the only custom production session cookie. Shopify owns its platform cookies. Every other repository remains cookie-free until a verified server identity boundary exists.
