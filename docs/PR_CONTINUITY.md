...
`test/pr-continuity.attack20.test.mjs` attacks ancestry, divergence, unknown state, TOCTOU, forks, machine-truth ordering, human-body preservation, malformed markers, proof-subject binding, authority/approval separation, stacked propagation, unrelated stacks, and cycles before any write step.
