...
- deterministic Cloudflare reasoning, request-trace/source contracts, and founder-gated Access recovery tooling that resolves the canonical `foundercontrolroom.org` zone and inspects both account- and zone-scoped Access applications before any exemption proposal; source existence still does not prove live provider configuration;
