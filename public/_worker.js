...
const API_OWNED_ASSET_PATHS = new Set([
...
function shouldServeFromPages(request) {
  ...
  // The onboarding callback assets are generated by the API router. They look
  // static, but Pages does not publish them; routing them to ASSETS strands the
