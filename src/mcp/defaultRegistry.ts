...
export const DEFAULT_MCP_SERVERS: readonly McpServerDefinition[] = [
  ...
  {
    id: "componecat",
    label: "Componecat MCP",
    role: "portfolio-architecture-context",
    endpointEnv: "MCP_COMPONECAT_URL",
    authTokenEnv: "COMPONECAT_MCP_TOKEN",
    enabledProjects: ALL_ACTIVE_PROJECTS,
    allowedToolPatterns: [
      "search_catalog",
      "get_*",
  ...
  {
    id: "cloudflare-api",
    label: "Cloudflare API MCP",
    role: "cloudflare-provider-schema-discovery",
    endpointEnv: "MCP_CLOUDFLARE_API_URL",
    authTokenEnv: "FCR_CLOUDFLARE_MCP_READ_TOKEN",
    enabledProjects: ALL_ACTIVE_PROJECTS,
    allowedToolPatterns: ["search"],
    deniedToolPatterns: ["execute"],
    defaultRisk: "read",
    monthlyBudgetUsd: 0,
  },
  {
