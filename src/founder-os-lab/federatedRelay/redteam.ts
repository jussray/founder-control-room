import type { FederatedAgentRelayEnvelopeV31 } from './v31-types.js';
...
export const RELAY_V31_MUTATIONS: readonly RelayAttackMutationV31[] = [
  ...
  { name: 'evidence_provider_invalid', apply: (e) => { e.evidence[0].locator.provider = 'internet' as never; } },
  { name: 'evidence_state_invalid', apply: (e) => { e.evidence[0].state = 'believed' as never; } },
