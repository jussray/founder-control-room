...
export const PORTFOLIO_DESIGN_REGISTRY = [
  ...
  },
  {
    ...
    runtimeProfile: "Expo Router, React Native and React Native Web, TypeScript, Supabase, Cloudflare Workers, and a Python/FastAPI Piper TTS service",
    dataBoundary: "restricted",
  ...
  },
  {
    ...
    runtimeProfile: "Node.js 24 story runtime with built-in node:sqlite, creator studio, artifact provenance, event, and promotion pipelines",
    dataBoundary: "restricted",
    capabilityBranch: "agent/figma-build-implement-skill",
  ...
  },
  {
    ...
    runtimeProfile: "Vanilla HTML, CSS, and JavaScript SPA with a Cloudflare Worker backend/runtime and runtime identity routes",
    dataBoundary: "restricted",
    capabilityBranch: "agent/figma-build-implement-skill",
  ...
  },
  {
    ...
    runtimeProfile: "React, TypeScript, and Vite storefront with a minimal Cloudflare checkout-session Worker",
    dataBoundary: "public",
    capabilityBranch: "agent/figma-build-implement-skill",
