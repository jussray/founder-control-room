...
export const PORTFOLIO_DESIGN_REGISTRY = [
  ...
  },
  {
    ...
    runtimeProfile: "Expo Router, React Native/Web, TypeScript, Supabase, Cloudflare Workers/Pages, and a Python/FastAPI Piper TTS service",
    dataBoundary: "restricted",
  ...
  },
  {
    ...
    runtimeProfile: "Node.js story runtime with built-in node:sqlite, creator studio, artifact provenance, event, and promotion pipelines",
    dataBoundary: "restricted",
    capabilityBranch: "agent/figma-build-implement-skill",
  ...
  },
  {
    ...
    runtimeProfile: "Vanilla HTML/CSS/JavaScript SPA with a JavaScript Cloudflare Worker backend, TypeScript domain contracts, MCP, capability-plan, and exact-release identity surfaces",
    dataBoundary: "restricted",
    capabilityBranch: "agent/figma-build-implement-skill",
