...
export const TERMINAL_COMMANDS: readonly TerminalCommandSpec[] = [
  ...
  spec('juss-beautiful-hair-private', 'jbh-private/admin', 'verify.ai-skills', 'Verify private hair AI skill contracts', 'npm', ['run', 'verify:ai-skills'], 'verify', {evidenceKind: 'artifact_provenance'}),
  ...
  spec('juss-beautiful-hair', 'jussbeautifulhair-site', 'verify.ai-skills', 'Verify public hair AI skill contracts', 'npm', ['run', 'verify:ai-skill-contract'], 'verify', {evidenceKind: 'artifact_provenance'}),
  ...
  spec('untold-stories', 'untold-stories-storefront', 'verify.ai-skills', 'Verify Untold Stories AI skill contracts', 'npm', ['run', 'verify:ai-skill-contract'], 'verify', {evidenceKind: 'artifact_provenance'}),
