  ...
  <main class="shell">
    ...
    <section id="signed-in" hidden>
      ...
      <section class="panel password">
        <div>
          <p class="eyebrow">Credential handoff</p>
          <h2>Set or change your founder password.</h2>
          <p>Use this after magic-link login so the founder owns the credential. Passwords are sent only to Supabase Auth and are never stored by Control Room.</p>
        </div>
