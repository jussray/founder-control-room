...
<body>
  <main class="shell">
    ...
    <section id="signed-out" class="panel auth" hidden>
      ...
      <ol class="steps">
        <li><b>1</b> Enter the allowlisted email.</li>
        <li><b>2</b> Open the one-time inbox link.</li>
        <li><b>3</b> Return with an HttpOnly session.</li>
      </ol>
    </section>
...
const CSS = `:root{font-family:Inter,ui-sans-serif,system-ui,sans-serif;color:#f5f7fb;background:#070b14;color-scheme:dark}*{box-sizing:border-box}body{margin:0;min-height:100vh;background:radial-gradient(circle at 10% 5%,#1a376d80,transparent 34rem),radial-gradient(circle at 90% 10%,#42206b55,transparent 30rem),#070b14}button,input{font:inherit}.shell{width:min(1080px,calc(100% - 32px));margin:auto;padding:48px 0 72px}.callback{width:min(680px,calc(100% - 32px));padding-top:14vh}.masthead,.identity{display:flex;justify-content:space-between;gap:24px;align-items:flex-start}.masthead{margin-bottom:28px}h1,h2,p{margin-top:0}h1{font-size:clamp(2.2rem,6vw,4.5rem);letter-spacing:-.055em;line-height:.96;margin-bottom:14px}h2{letter-spacing:-.025em}p,.card span{color:#aeb8cb;line-height:1.65}.eyebrow,.card small{color:#84aaff;text-transform:uppercase;letter-spacing:.13em;font-size:.72rem;font-weight:800}.panel{border:1px solid #96abd32d;background:#0f1626cc;border-radius:24px;padding:clamp(22px,4vw,38px);box-shadow:0 24px 80px #0006}.auth{display:grid;grid-template-columns:1.1fr .9fr;gap:30px}.auth .steps{grid-column:1/-1}.steps{display:grid;gap:10px;padding:0;margin:0;list-style:none;color:#aeb8cb}.steps li{display:flex;align-items:center;gap:10px}.steps b{display:grid;place-items:center;width:28px;height:28px;border-radius:50%;background:#172542;color:#8db1ff}form{display:grid;gap:12px}label{font-weight:750}input{border:1px solid #2b3a58;border-radius:14px;padding:14px 16px;background:#0a1020;color:#fff}button{border:0;border-radius:14px;padding:14px 18px;background:#8db1ff;color:#071024;font-weight:850;cursor:pointer}button.secondary{background:#18233a;color:#edf2ff;border:1px solid #304263}button:disabled{opacity:.62;cursor:wait}.grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin:18px 0}.card{display:grid;gap:9px;min-height:160px;padding:24px;text-decoration:none;color:#eef3ff;border-radius:20px;border:1px solid #25334f;background:#0d1425}.card strong{font-size:1.2rem}.truth{border-color:#edb44747}.notice{min-height:28px;margin:18px 4px 0}.status{border-radius:999px;padding:9px 12px;font-size:.78rem;font-weight:800;white-space:nowrap}.pending{background:#172137}.ok{background:#123323;color:#a8f0c6}.error{background:#421c24;color:#ffc0c0}[hidden]{display:none!important}@media(max-width:760px){.shell{padding-top:28px}.masthead,.identity{flex-direction:column}.auth,.grid{grid-template-columns:1fr}.identity button{width:100%}}`;
